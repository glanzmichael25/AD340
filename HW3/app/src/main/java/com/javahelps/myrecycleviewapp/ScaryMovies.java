...
public class ScaryMovies {
    ...
    public ScaryMovies(String title) {
        this.title = title;
    }
    ...
    public static ScaryMovies[] initMovies() {
        ...
        movieArray.add(new ScaryMovies.Builder()
                ...
                .description("In the tradition of Romero, modern Zombie films have become known as the home of sharp social commentary and forward-thinking humanism. You won’t find any of that in Planet Terror. Initially released as one half of the Robert Rodriguez/Quentin Tarantino double feature Grindhouse, Planet Terror was initially dismissed by critics as the lesser of the two entries, but time has proven it to be a raucous, endlessly rewatchable, and consummately reprobate entry to the zombie genre.Written and directed by Rodriguez (though cast interviews revealed that the directors collaborated freely on both pictures), Planet Terror is cheeky, free-wheeling, and delighted with its own depravity as it employs the shield of grindhouse tropes to hack through horror taboos from child death to testicular violence.\\nBorrowing heavily from the exploitation aesthetic with the kind of budget its forbears could only dream of, the film stars Rose McGowan as Cherry Darling, a brassy go-go dancer who finds herself in the midst of the apocalypse with a rag-tag band of survivors — played by an A+ ensemble of underrated actors who finally get to play the leading roles they’ve always deserved. Flesh-hungry humanoid mutants tear through the Texas countryside, leaving a gooey trail of body parts in their wake. In short order, Cherry winds up with a machine gun for a leg, as you do, and the film boils over into a chaotic free-for-all of bloodshed and grotesqueries. It’s a blast and it \n" +
                        "        triumphs because it leans in so hard. Just look at the “missing reel”  in the second act, which skips everybody’s least favorite part of a zombie movie and jumps right into the climactic third act. And that’s Planet Terror in a nutshell; audacious, goofy and always going right for the guts. — Haleigh Foutch")
                .build());
        ...
        movieArray.add(new ScaryMovies.Builder()
                ...
                .description("Peter Jackson could have only made this gory, gushy, and occasionally outright repulsive zombie film, and he would still be a kind of legend, if not at the level of the man who brought Lord of the Rings to the big-screen. Dead Alive openly toys with one of horror’s most cherished concepts – repression – and when Lionel’s (Balme) love for a local girl is no longer held down by his controlling mother (Moody), out come the decaying zombie-like creatures to act as a horrifying expression of momma’s villainous control. Like Tobe Hooper and Stuart Gordon’s iconic 1980s output, Dead Alive (also known as Braindead) \n" +
                        "        strives for what Hooper called “red humor,” a melding of slapstick and physical comedy with horror, and the result is the most idiosyncratic and zany effort that Jackson produced, complete with zombie-monster momma and rotted ears and noses garnishing a nice Sunday chowder. — Chris Cabin")
                .build());
